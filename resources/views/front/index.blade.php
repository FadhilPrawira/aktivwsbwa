                            ...
                            <div class="flex flex-col gap-[18px]">
                                <div class="flex items-center gap-3">
                                    <div class="w-16 h-16 rounded-full flex shrink-0 overflow-hidden">
                                        <img src="{{ Storage::url($itemNewWorkshops->instructor->avatar) }}"
                                            class="w-full h-full object-cover" alt="Instructor avatar">
                                    </div>
                                    <div class="flex flex-col gap-[2px]">
                                        ...
                                        <p class="font-medium text-aktiv-grey">
                                            {{ $itemNewWorkshops->instructor->occupation }}
                                        </p>
                                    </div>
                                </div>
                                <div class="thumbnail-container relative h-[200px] rounded-xl bg-[#D9D9D9] overflow-hidden">
                                    <img src="{{ Storage::url($itemNewWorkshops->thumbnail) }}"
                                        class="w-full h-full object-cover" alt="Workshop thumbnail">

                                    @if ($itemNewWorkshops->is_open)
                                        @if ($itemNewWorkshops->has_started)
                                            <div
                                                ...
                                                <img src="{{ asset('assets/images/icons/timer-start.svg') }}"
                                                    class="w-6 h-6" alt="workshop started icon">
                                        ...
                                        @else
                                            <div
                                                ...
                                                <img src="{{ asset('assets/images/icons/medal-star.svg') }}"
                                                    class="w-6 h-6" alt="workshop open icon">
                                ...
                                <div class="card-detail flex flex-col gap-2">
                                    <div class="flex items-center gap-3">
                                        <div class="flex items-center gap-1">
                                            ...
                                            <span class="font-medium text-aktiv-grey">
                                                {{ $itemNewWorkshops->started_at->format('d M Y') }}
                                            </span>
                                        </div>
                                        <div class="flex items-center gap-1">
                                    ...
                                    <h3
                                        ...
                                        {{ $itemNewWorkshops->name }}</h3>
                                    <p class="font-medium text-aktiv-grey">{{ $itemNewWorkshops->category->name }}</p>
                                </div>
                            </div>
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap-[6px]">
                                    <p class="font-semibold text-2xl leading-8 text-aktiv-red">
                                        Rp{{ number_format($itemNewWorkshops->price, 2, ',', '.') }}</p>
                        ...
                        <div class="swiper-slide">
                            <div
                                ...
                                <div
                                    ...
                                    <p class="font-['Neue-Plak-bold'] font-bold text-[32px] leading-[60.8px] text-white">
