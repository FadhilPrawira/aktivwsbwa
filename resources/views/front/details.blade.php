                    ...
                    <section id="Header" class="flex flex-col gap-6">
                        <div id="Rating" class="flex items-center gap-4">
                            <div
                                ...
                                <img src="{{ Storage::url($workshop->category->icon) }}" class="w-6 h-6 flex shrink-0"
                                    alt="icon">
                            ...
                            <div class="grid grid-cols-2 gap-6">
                                <div
                                    ...
                                    <img src="{{ asset('assets/images/icons/Duration.png') }}"
                                        class="w-16 h-16 flex shrink-0" alt="workshop time icon">
                                </div>
                                <div
                                    class="flex items-center justify-between rounded-2xl border border-[#E6E7EB] p-5 gap-4 bg-white">
                                    <div class="flex flex-col gap-2">
                                    ...
                                    <img src="{{ asset('assets/images/icons/Kick off date.png') }}"
                                        class="w-16 h-16 flex shrink-0" alt="workshop kick off date icon">
                                </div>
                            </div>
                        </div>
                    </section>
                        ...
                        <div class="relative flex w-full h-[360px] rounded-2xl overflow-hidden bg-[#D9D9D9]">
                            <div
                                ...
                                <div class="flex flex-col gap-3 justify-between">
                                    ...
                                    <a target="_blank"
                                        href="https://www.google.com/maps/search/{{ $workshop->address }}/"
                    ...
                    <div class="flex flex-col rounded-3xl p-8 gap-4 bg-white">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <img src="{{ asset('assets/images/icons/verify.svg') }}"
                                class="flex w-[62px] h-[62px] shrink-0" alt="verified instructor icon">
                        </div>
                    </div>
                            ...
                            @if ($workshop->has_started)
                                <div class="flex flex-col">
                                    ...
                                    <div class="p-4 bg-aktiv-red">
                                        <p class="font-semibold text-lg leading-[27px] text-center text-white">Oops! Sorry,
                                            it seems that registration for this workshop is now closed 🙌🏻 . </p>
                                    </div>
                                </div>
                            @else
                                <div class="flex flex-col">
                                    <a href="{{ route('front.booking', $workshop->slug) }}"
                                        class="flex items-center justify-center mx-8 h-16 rounded-xl px-6 gap-[10px] bg-aktiv-orange font-semibold text-lg leading-[27px] text-white mb-8">
                                        Join Workshop</a>
                                </div>
                            @endif
                        @else
